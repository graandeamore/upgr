...
//         document.getElementById("collapsible").style.borderRadius ="50px 0px 0px 0px";
...
// }
                              ...
                              // var activeform = document.getElementsByClassName(".active");
                              
                              // for (i = 0; i < activeform.length; i++ ){
                              //   activeform[i].addEventListener("click", function(){
                              //     setTimeout(function(){
                                     
                              //       document.getElementById("main__title").style.borderRadius ="50px 50px 0px 0px";
...
//         document.getElementById("collapsible").style.borderRadius ="0px";
       
        
//       }, 195);
//     } else {
//       content.style.maxHeight = content.scrollHeight + "px";
//       document.getElementById("collapsible").style.borderRadius ="50px 50px 0px 0px";
//     } 
//   });
// }
